...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/peiyao/peiyao/gscam/src/gscam)
  set(gscam_DEVEL_PREFIX /home/peiyao/peiyao/gscam/devel/.private/gscam)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/peiyao/peiyao/gscam/install)
...
if(NOT "/home/peiyao/peiyao/gscam/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/peiyao/peiyao/gscam/src/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/peiyao/peiyao/gscam/src/gscam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/peiyao/peiyao/gscam/devel/.private/gscam/lib;/home/peiyao/peiyao/gscam/devel/lib;/home/peiyao/peiyao/goal_position_publisher/devel/lib;/home/peiyao/peiyao/eye/devel/lib;/opt/ros/melodic/lib)
