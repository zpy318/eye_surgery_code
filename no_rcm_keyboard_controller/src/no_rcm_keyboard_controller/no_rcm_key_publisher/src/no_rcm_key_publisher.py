...
def no_rcm_key_publisher():
    pub = rospy.Publisher('no_rcm_key_input', no_rcm_key_publisher_msgs, queue_size=10)
    rospy.init_node('no_rcm_key_publisher', anonymous=True)
    rate = rospy.Rate(100) # 100hz
    while not rospy.is_shutdown():
        msg = no_rcm_key_publisher_msgs()
