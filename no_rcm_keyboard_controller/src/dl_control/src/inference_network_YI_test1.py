...
# camera_image_path = '/home/peiyao/Desktop/record_camera_and_b_scan/data/camera_image_1720820078.79/camera_image_6.jpg'
# b_scan_raw_path = '/home/peiyao/Downloads/1188.jpg'
...
def run_yolov5_inference(yolov5_dir, weights_path, image_path):
    ...
    os.system(f'python {detect_script} --weights {weights_path} --source {image_path} --conf 0.25 --iou 0.45 --save-txt --save-conf')
...
#         print(keypoint)
#         tip_x=keypoint[0, 0].item()
#         tip_y = keypoint[0, 1].item()
#         print("tip_x:", tip_x)
#         print("tip_y", tip_y)
...
while not rospy.is_shutdown():
    justify_contact = input("Need justification for contact (y/n): ").lower()
    
    if justify_contact == 'y':
        pub_tip_vel.publish(Vector3(0, 0, -downward_linear_vel * linear_vel))
