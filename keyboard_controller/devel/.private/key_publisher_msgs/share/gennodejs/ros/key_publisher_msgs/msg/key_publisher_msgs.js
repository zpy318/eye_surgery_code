...
// (in-package key_publisher_msgs.msg)
...
class key_publisher_msgs {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new key_publisher_msgs(null);
  ...
  static datatype() {
    ...
    return 'key_publisher_msgs/key_publisher_msgs';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new key_publisher_msgs(null);
...
module.exports = key_publisher_msgs;
