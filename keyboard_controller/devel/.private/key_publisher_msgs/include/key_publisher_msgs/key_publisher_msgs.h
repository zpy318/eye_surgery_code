// Generated by gencpp from file key_publisher_msgs/key_publisher_msgs.msg
// DO NOT EDIT!


#ifndef KEY_PUBLISHER_MSGS_MESSAGE_KEY_PUBLISHER_MSGS_H
#define KEY_PUBLISHER_MSGS_MESSAGE_KEY_PUBLISHER_MSGS_H
...
namespace key_publisher_msgs
{
template <class ContainerAllocator>
struct key_publisher_msgs_
{
  typedef key_publisher_msgs_<ContainerAllocator> Type;
  ...
  key_publisher_msgs_(const ContainerAllocator& _alloc)
    : move_left(false)
    , move_right(false)
    , move_up(false)
    , move_down(false)
  ...
  typedef boost::shared_ptr< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> const> ConstPtr;

}; // struct key_publisher_msgs_

typedef ::key_publisher_msgs::key_publisher_msgs_<std::allocator<void> > key_publisher_msgs;

typedef boost::shared_ptr< ::key_publisher_msgs::key_publisher_msgs > key_publisher_msgsPtr;
typedef boost::shared_ptr< ::key_publisher_msgs::key_publisher_msgs const> key_publisher_msgsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator1> & lhs, const ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
{
  ...
  static const char* value(const ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc153bb0a32a052adULL;
  static const uint64_t static_value2 = 0x0d10173dacb72523ULL;
};

template<class ContainerAllocator>
struct DataType< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::key_publisher_msgs::key_publisher_msgs_<ContainerAllocator>& v)
  {
    s << indent << "move_left: ";
...
#endif // KEY_PUBLISHER_MSGS_MESSAGE_KEY_PUBLISHER_MSGS_H
